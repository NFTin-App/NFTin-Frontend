...
import { GhostButton, Image, ScreenContainer, View } from '@shared/ui';
        ...
        <ScreenContainer noScroll noPadding>
            ...
            <OnboardingSlider onFinish={handleFinishOnboarding}>
                <OnboardingSlide
                    ...
                    image={<Image source={slide1} width={194} height={180} />}
                    description={
                ...
                <OnboardingSlide
                    ...
                    image={<Image source={slide2} width={117} height={180} />}
                    description='Find people with similar tastes and follow them'
                />
                <OnboardingSlide
                    title='Earn tokens'
                    image={<Image source={slide3} width={212} height={180} />}
