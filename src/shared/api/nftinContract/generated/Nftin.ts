...
export declare namespace NFTinStorage {
    ...
    export type CommentsStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber] & {
        profileId: BigNumber;
        profileIdPointed: BigNumber;
        pubId: BigNumber;
        pubIdPointed: BigNumber;
...
export interface NftinInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'getProfile', values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'lensAddress', values?: undefined): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'profiles', values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'rating', values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'setMirror', values: [DataTypes.MirrorDataStruct]): string;
    encodeFunctionData(functionFragment: 'setPost', values: [DataTypes.PostDataStruct]): string;
    ...
    decodeFunctionResult(functionFragment: 'getPostList', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'getProfile', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'lensAddress', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'onboardNewProfile', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'setLensHubAddress', data: BytesLike): Result;
...
export type likedEvent = TypedEvent<[string, BigNumber, BigNumber], likedEventObject>;
...
export type postedEvent = TypedEvent<[string, DataTypes.PostDataStructOutput], postedEventObject>;
...
export type profileOnboardedEvent = TypedEvent<[string, BigNumber], profileOnboardedEventObject>;

export type profileOnboardedEventFilter = TypedEventFilter<profileOnboardedEvent>;
...
export interface Nftin extends BaseContract {
    ...
    functions: {
        ...
        profiles(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;

        rating(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        setComment(vars: DataTypes.CommentDataStruct, overrides?: CallOverrides): Promise<void>;
        ...
        setMirror(vars: DataTypes.MirrorDataStruct, overrides?: CallOverrides): Promise<void>;

        setPost(vars: DataTypes.PostDataStruct, overrides?: CallOverrides): Promise<void>;
    };
